...
| <p><strong>alert_status </strong><mark style="color:green;background-color:orange;"><strong>(beta)</strong></mark><br><strong></strong>type: array</p><p>optional</p> | <p>Specifies the Run Status that will trigger the alert.</p><p>Possible values: FAILED, SUCCESS, NO_MATCH, CHECKED.</p>                                                                                                                                                                               |
