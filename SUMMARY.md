...
* [Export data with Tables to Storage](data-pipeline-operations/export-data-with-tables-to-storage/README.md)
  * [\[V1: deprecated\] Table to Storage configuration file](data-pipeline-operations/export-data-with-tables-to-storage/table-to-storage-configuration-file.md)
  * [\[V3\] Table to Storage configuration file](data-pipeline-operations/export-data-with-tables-to-storage/table-to-storage-configuration-file-1.md)
